...
//        }
        ...
        try {
            GitHub gitHub = GitHub.connect("virenmody", "a74c9704e00d767da4fe1d34aaf0ed8603d8ea11");
            testRepo = gitHub.getRepository("SquareSquash/java");
            List<GHIssue> issueList = testRepo.getIssues(GHIssueState.CLOSED);
            System.out.println("Here is my issueList: " + issueList);
        } catch (IOException e) {
            System.out.println("GH API IOException for getPullRequests: " + e.getMessage());
        }
